<?php
	...
	if(trim($name) == "" || trim($email) == "" || trim($message) == "" || trim($subject) == ""|| trim($email2) != "" || trim($verification) == "" || $verification != $sum || !filter_var($email, FILTER_VALIDATE_EMAIL) || $key != $key2){
		echo 3;
		exit();
	}
	...
	$recipient = "support@Rakselav.com";
	$subject = "$subject";
