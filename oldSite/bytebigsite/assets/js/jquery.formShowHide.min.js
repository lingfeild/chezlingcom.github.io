...
! function (e) {
  e.formShowHide = function (o, n) {
    var i = this;
    i.$el = e(o), i.el = o, "undefined" == typeof i.$el.data("formShowHide") && (i.options = e.extend({}, e.formShowHide.defaultOptions, n), i.$el.data("formShowHide", i), i.nodeType = i.el.nodeName.toUpperCase(), i.inputType = "INPUT" === i.nodeType ? i.$el.attr("type").toUpperCase() : "", i.showType = "", i.showParams = "", i.init = function () {
      ...
      if ("SELECT" === i.nodeType || "OPTION" === i.nodeType) {
        ...
        n = i.checkShowDefined(t.find("option:selected")), t.find("option").each(function (o, t) {
      ...
      if ("SELECT" === i.nodeType || "OPTION" === i.nodeType) {
        ...
        t = i.checkHideDefined(r.find("option:selected")), r.find("option").each(function (o, n) {
      ...
      return n.length === f.length && 1 === n.length ? f : (e(n).each(function (e, o) {
        for (var n in f)
          if (f[n] === o) return void f.splice(n, 1)
      }), f)
